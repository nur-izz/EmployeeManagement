                ...
                <div class="col-md-12">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-header">
                            ...
                            <a style="border-radius: 0.5rem;font-size: 15px; font-family: exo;display:block; background:#50D492; border-color: #50D492;" href="{{url('signup')}}" class="btn btn-sm btn-primary">SIGN UP</a><br>
                            <h6 style="font-size: 14px; font-family: open-sans;">Already a User?
                                <a class="btn" style="border-block: none;display: contents; color:#243665" href="{{url('signup')}}">Login here</a>
                            </h6>
                        </div>
                    </div>
                </div>
