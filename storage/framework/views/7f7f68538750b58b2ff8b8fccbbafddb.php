                    ...
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card" style="border: 0px; background-color: transparent;">
                            <div class="card-header">
                                <h4>Employee
                                <a href="<?php echo e(url('add-employee')); ?>" style="color:#50D492; background:transparent; border-color: #50D492; border-radius: 0.5rem;"class="btn btn-sm btn-primary">ADD NEW EMPLOYEE</a>
                                <a href="<?php echo e(url('removed-employee')); ?>" style="color:#323232; background:transparent; border-color: transparent; border-radius: 0.5rem;" class="btn btn-sm btn-primary">REMOVED EMPLOYEE</a>
                                ...
                                <div class="card-header" style="display:flex;padding: 15px 0px;">
                                    <div class="card" style="margin-right:16px;border-radius: 14px; width: 436px;">
                                        <div class="card-header">
                                            ...
                                            <a class="btn float-end" style="border-block: none; color:#243665" href="<?php echo e(url('edit-employee')); ?>">edit</a></div>
                            ...
                            <br>
                                ...
                                <div class="card" style="border: 0px;background-color: transparent;">
                                    <div class="card-header">
                                        <h4>Addresses
                                            <a href="<?php echo e(url('add-address')); ?>" style="color:#50D492; background:transparent; border-color: #50D492; border-radius: 0.5rem;" class="btn btn-sm btn-primary">NEW ADDRESS</a>
                                        </h4>
                                            ...
                                            <div class="card" style="margin-right:16px;border-radius: 14px; width: 436px;">
                                                <div class="card-header">
                                                    <div style="color:#389466; display:contents; font-size:20px; font-family:Exo">Address Name
                                                        <a class="btn float-end" style="border-block: none; color:#243665" href="<?php echo e(url('edit-address')); ?>">edit</a>
                                                    </div>
...
<?php /**PATH D:\laragon\www\EmployeeManagement\resources\views/employee/index.blade.php ENDPATH**/ ?>