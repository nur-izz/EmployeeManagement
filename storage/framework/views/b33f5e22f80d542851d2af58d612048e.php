                ...
                <div class="col-md-12">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-header">
                            <h5 style="font-family: exo;font-size:20px;margin-bottom: 10px; margin-top:10px">Edit Address</h5>
                                <div>
                                ...
                                <a style="border-radius: 0.5rem;font-size: 15px; font-family: exo;display:block; background:#50D492; border-color: #50D492;" href="<?php echo e(url('save-address')); ?>" class="btn btn-sm btn-primary">SAVE</a><br>
                        </div>
                    </div>
                 </div>
            </div>
...
<?php /**PATH D:\laragon\www\EmployeeManagement\resources\views/addresses/editaddresses.blade.php ENDPATH**/ ?>