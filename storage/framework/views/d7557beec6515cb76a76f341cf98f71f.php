                    ...
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-header">
                            <h4 style="font-family: exo;margin-bottom: 30px; margin-top:20px">Login</h4>
                                ...
                                <a style="border-radius: 0.5rem;font-size: 15px; font-family: exo;display:block; background:#50D492; border-color: #50D492;" href="<?php echo e(url('signin')); ?>" class="btn btn-sm btn-primary">SIGN IN</a><br>

                            <h6 style="font-size: 14px; font-family: open-sans;">Not a User?
                                <a class="btn" style="border-block: none;display: contents; color:#243665" href="<?php echo e(url('register')); ?>">Register here</a>
                            </h6>
                        </div>
                    </div>
                 </div>
...
<?php /**PATH D:\laragon\www\EmployeeManagement\resources\views/login.blade.php ENDPATH**/ ?>